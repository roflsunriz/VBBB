...
import { getBeSession, beLogout, parseBeId, buildBeProfileUrl } from '../../src/main/services/be-auth';
...
describe('getBeSession', () => {
  ...
  it('returns logged in when both DMDM and MDMD present', () => {
    ...
    setCookie({ name: 'MDMD', value: 'val2', domain: '.5ch.net', path: '/', sessionOnly: false, secure: false });
